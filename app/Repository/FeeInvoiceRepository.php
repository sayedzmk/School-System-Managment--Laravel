...
class FeeInvoiceRepository implements FeeInvoiceRepositoryInterface
{
    public function index()
    {
        ...
        return view('pages.Fee_Invoice.index',compact('Fee_invoices','Grades'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.Fee_Invoice.add',compact('student','fees'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.Fee_Invoice.edit',compact('fee_invoices','fees'));
    }
