        ...
        <div class="clearfix"></div>
                    ...
                    <li>
                        ...
                        <ul id="Grades-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('school_garde.index')}}">{{trans('main_trans.Grades_list')}}</a></li>
                    ...
                    <li>
                        ...
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('class_rooms.index')}}">{{trans('class_room_trans.List_classes')}}</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('section.index')}}">{{trans('sections_trans.List_Grade')}} </a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="students-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('student.create')}}">{{trans('main_trans.Add Students')}} </a> </li>
                            <li> <a href="{{route('student.index')}}">{{trans('main_trans.List Students')}}</a> </li>
                        </ul>
                    </li>
