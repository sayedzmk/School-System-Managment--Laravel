...
@section('css')
    @toastr_css
@section('title')
{{trans('question.List_of_question')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('questions.create') }}" class="btn btn-success btn-sm" role="button"
                                aria-pressed="true">{{trans('question.Add_a_new_question')}}</a><br><br>
                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"> {{trans('question.The_correct_answer')}}</th>
                                            <th scope="col">{{trans('question.score')}}</th>
                                            <th scope="col"> {{ trans('quize.Quize_name') }}</th>
