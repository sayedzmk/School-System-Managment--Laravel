            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <h6 style="color: rgb(224, 46, 46);font-family: Cairo">{{trans('promotion_student_trans.old school stage')}}</h6><br>
                    ...
                    <form method="post" action="{{ route('promotion.store') }}">
                        ...
                        <br><h6 style="color: rgb(224, 46, 46);;font-family: Cairo"> {{trans('promotion_student_trans.The new school stage')}}</h6><br>
