    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('promotion_student_trans.restoration_student')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Graduated.update','test')}}" method="post" autocomplete="off">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('Students_trans.Are you sure to cancel the graduation process?')}}</h5>
