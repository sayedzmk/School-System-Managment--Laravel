...
@section('title')
    {{ trans('teacher_tans.Edit_Teacher') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('teacher.update', 'test') }}" method="post">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{ trans('teacher_tans.Email') }}</label>
                                ...
                                <div class="col">
                                    <label for="title">{{ trans('teacher_tans.Password') }}</label>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{ trans('teacher_tans.Name_ar') }}</label>
                                ...
                                <div class="col">
                                    <label for="title">{{ trans('teacher_tans.Name_en') }}</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    <label for="inputCity">{{ trans('teacher_tans.specialization') }}</label>
                                ...
                                <div class="form-group col">
                                    <label for="inputState">{{ trans('teacher_tans.Gender') }}</label>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{ trans('teacher_tans.Joining_Date') }}</label>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">{{ trans('teacher_tans.Address') }}</label>
