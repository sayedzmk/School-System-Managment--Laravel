    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('fees_trans.Delete an invoice') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('fees_invoice.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">  {{ trans('fees_trans.Are you sure about the deletion process?') }}</h5>
